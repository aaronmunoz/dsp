...
>> Python 3. In general, if the pre-existing code you're working with is not dependent on an older version of a language, you should be using the newest stable version.
